        ...
        <div className="properties-scroll">
          {inspector === 'canvas' ? <>
            ...
            <fieldset disabled={selected.locked}>
              {selected.type === 'pepe' && <Section title="Лицо модели"><button className="button full face-open-button" disabled={selected.modelId === '061'} onClick={() => setDialog('face')}><Smile size={17} />Редактировать лицо</button><p className="face-section-note">{selected.modelId === '061' ? '061 — силуэт без отдельных деталей лица.' : 'Глаза, веки, пуговицы и улыбка · ориентир 002'}</p></Section>}
